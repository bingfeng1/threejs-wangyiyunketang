...
import { AxesHelper, BoxBufferGeometry, BoxGeometry, BufferAttribute, BufferGeometry, Color, Mesh, MeshBasicMaterial, MirroredRepeatWrapping, NearestFilter, PerspectiveCamera, RepeatWrapping, Scene, TextureLoader, WebGLRenderer } from 'three'
